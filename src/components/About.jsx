        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 items-start">
            ...
            <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold">
                    A developer who
                    <span className="gradient-text">loves building.</span>
                </h2>
            </div>
            ...
            <div className="text-slate-400 leading-relaxed space-y-5">
                ...
                <p>
                    ผมชื่อ <strong className="text-slate-200">Nonthee Panatuek</strong>
                    เป็นนักศึกษาชั้นปีที่ 4 มหาวิทยาลัยศรีปทุม
                    คณะเทคโนโลยี สาขาวิทยาการคอมพิวเตอร์และนวัตกรรมการพัฒนาซอฟต์แวร์
                </p>
                ...
                <p>
                    นอกจาก Software Development แล้ว
                    ผมยังสนใจการประยุกต์ใช้
                    <span className="text-purple-400">AI / NLP / RAG / Computer Vision</span>
