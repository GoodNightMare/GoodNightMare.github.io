...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-slate-800/70 glass">
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="h-16 flex items-center justify-between">
          <a href="#home" className="font-bold text-lg">
            <span className="text-cyan-400">&lt;</span> Nonthee{" "}
        ...
        >
          ...
          <a href="#skills" onClick={closeMenu} className="block nav-link">
            Skills
          </a>
          <a href="#projects" onClick={closeMenu} className="block nav-link">
            Projects
          </a>
          <a
            href="#achievements"
